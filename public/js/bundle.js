...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaHlwZXJodW1hbiIsImEiOiJja3N1a3ltbXkxaDg4MnluMWFlNGtkZ2lpIn0.Uh3aegDlcFsCcgPijnnU-Q';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/hyperhuman/cksvdvh80118f17qnhyifsx2j',
...
var stripe = Stripe('pk_test_51I429QACVO0I2rXHtIHwNTWP9l3jUsNNJkyyMSkjtnHzmLQb8pecwd08TspuGXJTAeginzv4SMhA79RO4MRFvQ4u00XQPy7EBs');
...
var bookBtn = document.getElementById('book-tour'); // Dom Elements
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "5602" + '/');
